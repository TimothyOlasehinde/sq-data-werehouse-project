...
BEGIN
	...
	RAISE INFO '=================================================================================';	
		...
		RAISE INFO '>> Inserting Data Into Table: silver.crm_sales_details';
		...
		SELECT 
			...
			sls_prd_key,
			sls_cust_id,
			CASE WHEN sls_order_dt = 0 OR LENGHT(sls_order_dt) != 8 THEN NULL
				ELSE CAST(CAST(sls_order_dt AS VARCHAR) AS DATE)
			END sls_order_dt,
			CASE WHEN sls_ship_dt = 0 OR LENGHT(sls_ship_dt) != 8 THEN NULL
				ELSE CAST(CAST(sls_ship_dt AS VARCHAR) AS DATE)
			END sls_ship_dt,
			CASE WHEN sls_due_dt = 0 OR LENGHT(sls_due_dt) != 8 THEN NULL
